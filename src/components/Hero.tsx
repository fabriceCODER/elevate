      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-2xl animate-fade-in">
          <h1 className="font-heading text-5xl sm:text-6xl lg:text-7xl font-bold text-foreground mb-6 leading-tight">
            <Link href="/shop" className="bg-primary hover:bg-primary-glow text-white font-semibold px-8 py-3 rounded-lg transition-all shadow-lg hover:shadow-xl">
              Shop Now
            </Link> to your best self,{" "}
